...
/*
UART (COM Port) ïðîòîêîë:
1 ñòàðò áèò
8 áèò äàííûõ
1 ñòîï áèò.

ÏÐÎÒÎÊÎË äëÿ DEMO version 1.0

1. Ñòðóêòóðà ïàêåòà.
    Ðàçìåð ïàêåòà: 15 áàéò
     1 áàéò - ÏÐÅÀÌÁÓËÀ 0x02 (stx)
    12 áàéò - ÄÀÍÍÛÅ. Âñåãäà 12 áàéò.
     1 áàéò - ÀÄÐÅÑ: Camera ID 2[7:6] áèòà, Port ID 2[5:4] áèòà, Packet ID 4[3:0] áèòà
     1 áàéò - CRC ñ ïîëèíîìîì 0x97. CRC ñ÷èòàåòñÿ äëÿ âñåõ òðåõ ïîëåé:
              Ïðåàìáóëû, Äàííûõ è Àäðåñà.

     Ïåðâûì ïåðåäàåòñÿ ïðåàìáóëà, çàòåì äàííûå ìëàäøèì áàéòîì âïåð¸ä, çàòåì àäðåñ è ïîñëåäíåé - crc.
     Ïîëèíîì CRC: 0x97 = x^8 + x^5 + x^3 + x^2 + x + 1.

     Camera ID - íîìåð êàìåðû. Äëÿ ÄÅÌÎ - êîíñòàíòà.
     Port ID - îïðåäåëÿåò òèï ïåðåäàâàåìûõ äàííûõ:
               00 - äàííûå êîíôèãóðàöèè/íàñòðîéêè
               11 - ñëóæåáíûå ñîîáùåíèÿ
               01 - âèäåî
               10 - àíàëèòèêà
     Packet ID - ïîðÿäêîâûé íîìåð ïàêåòà. Ñêâîçíàÿ íóìåðàöèÿ ïàêåòîâ
                 îò/â îäíîé è òîé æå êàìåðû äëÿ âñåõ òèïîâ äàííûõ.
                 Íåîáõîäèì äëÿ îáíàðóæåíèÿ ïîòåðè ïàêåòà.
*/
