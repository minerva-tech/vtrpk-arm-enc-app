...
*/
/*****************************************************************************/
int H264VENC_TI_GetArm926TcmBase( unsigned int *Ram0BaseAddr,
                                          unsigned int *Ram1BaseAddr,
                                          unsigned int size0,
                                          unsigned int size1)
{
    unsigned int arm926TCMsize = 0x8000;

	if(( size0 + size1) > arm926TCMsize)
	{
      *Ram0BaseAddr =(unsigned int) 0x00000000;
      *Ram1BaseAddr =(unsigned int) 0x00000000;	  
	}
	else
	{
      *Ram0BaseAddr =(unsigned int) 0x00011000;
      *Ram1BaseAddr =(unsigned int)(Ram0BaseAddr + size0) ;
	}
